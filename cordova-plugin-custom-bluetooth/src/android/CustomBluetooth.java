...
public class CustomBluetooth extends CordovaPlugin {
	public static final String TAG = "CordovaCustomBluetooth";
	public static final String SERVICE_NAME = "CordovaCustomBluetooth";
			...
			return true;
			  ...
			  //  intent.putExtra(BluetoothDevice.EXTRA_PAIRING_VARIANT,
			   //                 BluetoothDevice.PAIRING_VARIANT_CONSENT);
                callbackContext.success();
			 	return true;
		} else if(action.equals("unpairDevice")){
			 	String address = args.getString(0);
                BluetoothDevice device= mBluetoothAdapter.getRemoteDevice(address);
                try {
